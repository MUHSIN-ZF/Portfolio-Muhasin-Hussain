    ...
    return (
        ...
        >
            ...
            <div className='max-w-[1000px] h-fit mx-auto px-8 flex flex-col md:justify-center pt-5  md:pt-0 md:mt-0 absolute' >
                ...
                <h1 className='md:text-6xl text-4xl font-bold text-white'>Muhasin Hussain</h1>
                ...
                <div className='flex flex-col ' >
                    ...
                    <a href='/Srees.pdf' download={true} className='lg:hidden group border-2 py-3 px-6 my-2  flex items-center justify-center text-white w-fit'>
                        Resume
                        <span className=''>
                ...
                <div className='flex mt-8 lg:hidden  items-center'>
                    <ul className='flex '>
                        <li className='w-[20px] h-[60px]   duration-500 text-center'>
                            <a href="https://www.linkedin.com/in/muhsin-hussain-89b456249/" target="_blank" rel="noreferrer" className='text-white'>
                                <FaLinkedin size={30} />
                            </a>
                        </li>
                        <li className='w-[20px] h-[60px]   duration-500 mx-4'>
                            <a href="https://github.com/MUHSIN-ZF/" target="_blank" rel="noreferrer" className='text-white'>
                                <FaGithub size={30} />
                            </a>
                        </li>
                        <li className='w-[20px] h-[60px]  duration-500'>
                            <a href="mailto:muhsinzf@gmail.com" className='text-white'>
